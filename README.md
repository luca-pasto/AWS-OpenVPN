...
## 📄PDFs
- [Report PDF](pdf/MIS420-AWSProjectReport-LucaPasto.pdf)  
- [AWS Screenshot PDF](pdf/MIS420-AWSProjectScreenshots-LucaPasto.pdf)

## Project Steps

<p align="center"><img src="AWS-Project-IMG/1.vpc.jpg" alt="VPC" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/2.inbound-sg.jpg" alt="Inbound" width="900"/></p><p align="center"><img src="AWS-Project-IMG/2.outbound-sg.jpg" alt="Outbound" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/6.powershell-connection.jpg" alt="Powershell Connection" width="900"/></p><p align="center"><img src="AWS-Project-IMG/6.powershell-settings.jpg" alt="Powershell Settings" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/3.EC2-instance.jpg" alt="EC2 instance" width="900"/></p>

An elastic IP was associated with the instance, allowing it to have a static IP. This allows the user to successfully connect to the EC2 instance and have all traffic routed through that particular IP address. 

<p align="center"><img src="AWS-Project-IMG/5.ip-attachment.jpg" alt="attachment" width="900"/></p>

The following images show the connection with OpenVPN by using https://whatismyipaddress.com/ to show IP masking/spoofing.

<p align="center"><img src="AWS-Project-IMG/7.vpn-connection.jpg" alt="Prior" width="900"/></p><p align="center"><img src="AWS-Project-IMG/7.vpn-change.jpg" alt="Change" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/8.AMI.jpg" alt="AMI" width="900"/></p><p align="center"><img src="AWS-Project-IMG/9.AMI-bucket.jpg" alt="Backup1" width="900"/></p><p align="center"><img src="AWS-Project-IMG/10.backup-plan.jpg" alt="Backup-plan" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/11.CloudWatch-alarms.jpg" alt="Alarms" width="900"/></p><p align="center"><img src="AWS-Project-IMG/12.email-sub.jpg" alt="Sub" width="900"/></p><p align="center"><img src="AWS-Project-IMG/13.email-notification.jpg" alt="Notification" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/14.cloudwatch-s3-bucket.jpg" alt="S3-logs" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/15.admin-account.jpg" alt="user" width="900"/></p><p align="center"><img src="AWS-Project-IMG/15.inspector-role.jpg" alt="role" width="900"/></p>
...
<p align="center"><img src="AWS-Project-IMG/16.inspector-result.jpg" alt="results" width="900"/></p>
